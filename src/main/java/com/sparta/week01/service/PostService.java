...
public class PostService {
    ...
    public CommonResponse<List<PostRequestDto>> getPost(){
        ...
        for (Post post : postList)
            result.add(new PostRequestDto(post));
    ...
    public CommonResponse<Post>update(Long id, PostRequestDto requestDto) {
    ...
    public CommonResponse<Boolean> equalPassword(Long id, PostRequestDto requestDto) {
        Post post = postRepository.findById(id).orElseThrow(InvalidIdException::new);
